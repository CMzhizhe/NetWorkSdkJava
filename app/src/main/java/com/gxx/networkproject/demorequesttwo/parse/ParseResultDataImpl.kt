...
open class ParseResultDataImpl<T> : AbsOnRequestResultImpl() {
     ...
     * @Descriptiion 请求失败
     **/
    open fun onRequestDataFail(code: String, msg: String, baseBean: BaseModel?=null) {}
     ...
     * @Description 请求失败
     **/
    open fun onRequestBaseBeanFail(baseBean: BaseModel?=null) {}
     ...
     * 返回含有 BaseBean 的
     **/
    open fun onRequestBaseBeanSuccess(data: T?, baseBean: BaseModel) {}
