package com.gxx.networklibrary.networkpackge.requestencapsulutil;
...
public class MultipartBodyUtils {
    ...
    **/
     ...
     *注释描述:文件上传
     */
    public MultipartBody.Part createFileFormData(String keyStr, File file, UploadFileRequestBody uploadFileRequestBody){
        return MultipartBody.Part.createFormData(keyStr, file.getName(), uploadFileRequestBody);
    }
